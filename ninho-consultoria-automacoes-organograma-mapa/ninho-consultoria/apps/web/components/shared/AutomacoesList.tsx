      ...
      <div className="flex items-center justify-between mb-4 bg-white border border-[#eef0f2] rounded-2xl p-4">
        <div>
          ...
          <div className="text-[12px] text-[#9aa0ac] mt-0.5">
            "Parcela vencendo", "Contrato vencendo" e "Tarefa atrasada" rodam sozinhas ao abrir o Dashboard.
            "Diagnóstico concluído" e "Nova atividade" disparam na hora, assim que o evento acontece.
